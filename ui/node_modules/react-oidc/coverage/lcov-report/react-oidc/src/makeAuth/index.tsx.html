...
<html lang="en">
<head>
    <title>Code coverage report for react-oidc/src/makeAuth/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">react-oidc/src/makeAuth</a> index.tsx
    </h1>
    <div class='clearfix'>
...
const DEFAULT_CONTEXT: IAuthenticatorContext = {
  signOut: <span class="fstat-no" title="function not covered" >() =&gt; {</span>},
  user: null,
  userManager: null
}
...
<span class="cstat-no" title="statement not covered" >          this.setState(<span class="fstat-no" title="function not covered" >(</span>{ <span class="cstat-no" title="statement not covered" >context </span>}) =&gt; <span class="cstat-no" title="statement not covered" >({</span></span>
