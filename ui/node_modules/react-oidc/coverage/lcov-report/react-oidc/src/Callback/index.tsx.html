...
<html lang="en">
<head>
    <title>Code coverage report for react-oidc/src/Callback/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">react-oidc/src/Callback</a> index.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    redirectCallback()
      .then(user =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (onSuccess) {
